...
type ComplexityRoot struct {
	...
	Query struct {
		Block func(childComplexity int, number string) int
	}
}

type QueryResolver interface {
	Block(ctx context.Context, number string) (*model.Block, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.block":
		...
		return e.complexity.Query.Block(childComplexity, args["number"].(string)), true
...
var sources = []*ast.Source{
	{Name: "../../schema.graphql", Input: `type Block {
    number: String!
    hash: String!
    parentHash: String!
    nonce: String!
...
func (ec *executionContext) _Query_block(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Block(rctx, fc.Args["number"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	fc.Result = res
	return ec.marshalOBlock2ᚖGraphQL_demoᚋgraphᚋmodelᚐBlock(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalOBlock2ᚖGraphQL_demoᚋgraphᚋmodelᚐBlock(ctx context.Context, sel ast.SelectionSet, v *model.Block) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
